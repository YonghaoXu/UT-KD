...
def get_arguments():
    ...
    parser.add_argument("--data_ID", type=int, default=1,
                        help="target dataset ID. 1: City+IDD 2: City+Mapillary 3: IDD+Mapillary")
...
def main():
    ...
    if args.data_ID == 1:
        ...
        snapshot_dir = args.snapshot_dir+'synthetic2real_GTA2City_IDD/MTKD_out_weight_'+str(args.out_weight)+'_con_weight_'+str(args.con_weight)+'_time'+time.strftime('%m%d_%H%M', time.localtime(time.time()))+'/'
        ...
        snapshot_dir = args.snapshot_dir+'synthetic2real_GTA2City_Mapillary/MTKD_out_weight_'+str(args.out_weight)+'_con_weight_'+str(args.con_weight)+'_time'+time.strftime('%m%d_%H%M', time.localtime(time.time()))+'/'
        tgt2_loader = data.DataLoader(
        ...
        snapshot_dir = args.snapshot_dir+'synthetic2real_GTA2IDD_Map/MTKD_out_weight_'+str(args.out_weight)+'_con_weight_'+str(args.con_weight)+'_time'+time.strftime('%m%d_%H%M', time.localtime(time.time()))+'/'
        tgt1_loader = data.DataLoader(
