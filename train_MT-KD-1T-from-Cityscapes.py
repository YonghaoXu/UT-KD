...
def get_arguments():
    ...
    parser.add_argument("--data_ID", type=int, default=1,
                        help="target dataset ID. 1: IID 2: Mapillary")
...
def main():
    ...
    if args.data_ID == 1:
        ...
        snapshot_dir = args.snapshot_dir+'real2real_City2IDD/MTKD_out_weight_'+str(args.out_weight)+'_con_weight_'+str(args.con_weight)+'_time'+time.strftime('%m%d_%H%M', time.localtime(time.time()))+'/'
        ...
        snapshot_dir = args.snapshot_dir+'real2real_City2Mapillary/MTKD_out_weight_'+str(args.out_weight)+'_con_weight_'+str(args.con_weight)+'_time'+time.strftime('%m%d_%H%M', time.localtime(time.time()))+'/'
        tgt_loader = data.DataLoader(
