...
def test_mIoU7(f,model, data_loader, epoch,input_size, print_per_batches=10):
    ...
    name_classes = np.array(["flat","construction","object","nature","sky","human","vehicle"], dtype=np.str)
